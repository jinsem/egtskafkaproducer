...
func NewEgtsRecordWriter(writer io.Writer, codec container.Codec, recordsPerBlock int64) (*container.Writer, error) {
	str := &EgtsRecord{}
	return container.NewWriter(writer, codec, recordsPerBlock, str.Schema())
}

func DeserializeEgtsRecord(r io.Reader) (*EgtsRecord, error) {
	t := NewEgtsRecord()
...
func (r *EgtsRecord) SetDefault(i int) {
	switch i {

	}
	panic("Unknown field index")
}
func (_ *EgtsRecord) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ *EgtsRecord) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ *EgtsRecord) Finalize()                        {}

type EgtsRecordReader struct {
	r io.Reader
	p *vm.Program
}

func NewEgtsRecordReader(r io.Reader) (*EgtsRecordReader, error) {
	...
	return &EgtsRecordReader{
		r: containerReader,
		p: deser,
	}, nil
}

func (r *EgtsRecordReader) Read() (*EgtsRecord, error) {
	t := NewEgtsRecord()
